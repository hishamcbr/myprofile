      ...
      <div class="card-body row">
        ...
        <div class="col-sm-12">
          ...
          <el-table class=""
            ...
            <slot name="deficiency" v-if="page.total"></slot>
        ...
        <div class="col-sm-6 pagination-info">
          <p v-show="total" class="category">Showing {{from + 1}} to {{to}} of {{total}} entries</p>
          <p v-show="!total" class="category">Showing 0 to 0 of {{total}} entries</p>
        </div>
...
import Vue from 'vue'
  ...
  // Vue.use(Option)
export default {
    props: ['page','reload','reset','noBackground'],
    components: {
      PPagination
    },
    methods: {
